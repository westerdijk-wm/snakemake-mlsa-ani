...
def test_extract_mapping(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/integration/extract_mapping/config")
        data_path = Path(".tests/integration/extract_mapping/data")
        expected_path = Path(".tests/integration/extract_mapping/expected")
